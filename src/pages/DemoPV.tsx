...
const MAIN_TOOLS: Tool[] = [
  {
    ...
    description: "Transforme qualquer vídeo em conteúdo seu, pronto para postar.",
  ...
  {
    title: "Gerador Modelo de IA",
    description: "Crie um modelo fotorrealista para aparecer nos seus vídeos.",
    iconUrl: `${R2}/icon-iadevideos.png`,
    path: "/gerador-modelo-ia",
    dark: false,
    cardColor: "white",
  },
];
...
export default function DemoPV() {
