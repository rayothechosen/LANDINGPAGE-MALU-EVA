...
const MAIN_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: "Escolha um vídeo, as redes e publique ou programe em segundos.",
    iconUrl: `${R2}/icon-iadevideos.png`,
    path: "/publicador-automatico",
    dark: false,
    cardColor: "white",
  },
  {
    title: "Plano de Postagem",
    description: "Monte uma agenda completa de 7, 30 ou 90 dias de conteúdo.",
  ...
  if (featured) {
    return (
      <motion.button
        ...
        style={{ background: tool.cardColor, boxShadow: "0 4px 24px rgba(0,0,0,0.18), 0 1px 4px rgba(0,0,0,0.12)" }}
      >
...
export default function DemoPVI() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="max-w-md mx-auto px-5 pt-8 pb-0 flex items-center"
      >
